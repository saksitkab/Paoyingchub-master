...
public class game_login extends ActionBarActivity {
    ImageButton paper1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //player=MediaPlayer.create(game_login.this,R.raw.play);
    ...
    public void win(){
        ...
        player3=MediaPlayer.create(game_login.this,R.raw.win);
    ...
    public void lose(){
            ...
            public void done(ParseObject object, ParseException e) {
                if (object == null) {
                    Toast.makeText(getApplicationContext(), "Error.",
                     ...
                     temp = object.getInt("winstreak");
                }
            }
        });


        if(score > temp){    ParseQuery<ParseObject> query = ParseQuery.getQuery("Player");
            query.whereEqualTo("id_player", username);
            query.getFirstInBackground(new GetCallback<ParseObject>() {
                public void done(ParseObject object, ParseException e) {
                    if (object == null) {
        ...
        player2=MediaPlayer.create(game_login.this,R.raw.lose);
    ...
    public void buttonClicked2(View v) {
        ...
        switch (id) {
            ...
            case R.id.over:
                ...
                i = new Intent(this, newmain.class);
